      ...
      <div className="bg-white rounded-lg shadow-2xl max-w-md w-full max-h-[85vh] sm:max-h-[80vh] overflow-hidden">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-3 sm:p-4 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-base sm:text-xl font-bold text-white">Program Updates</h2>
          </div>
          <button
            onClick={onClose}
            ...
            >
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs sm:text-sm text-gray-800 font-medium break-words">{notification.message}</p>
        ...
        <div className="p-3 sm:p-4 bg-gray-50 border-t border-gray-200">
          {notifications.length > 0 && notifications[0].new_status === 'open' ? (
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 sm:py-2 px-4 rounded-lg transition-colors text-sm sm:text-base"
            >
              Enroll Now
            </button>
          ) : (
